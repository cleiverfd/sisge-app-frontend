...
<template>
    ...
    <div id="main-content" class="p-4 md:ml-64 h-full pt-20 bg-gray-50 dark:bg-gray-900">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                            ...
                            and is meant to
                            ensure a common set of data rights in the European Union. It requires organizations to notify
                            users as soon as
                            ...
                            <form class="flex items-center">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="text" id="simple-search"
                                        ...
                                        placeholder="Buscar expediente o procesal" required="">
                                </div>
                            </form>
                        </div>
                        <div
