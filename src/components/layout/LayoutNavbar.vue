    ...
    <nav
        ...
        <div class="flex flex-wrap justify-between items-center">
            ...
            <div class="relative flex items-center lg:order-2">
                <button type="button" @click="toogleSearch()"
                ...
                <!-- Notifications -->
                <button type="button" @click="toogleNotifications()"
                ...
                <!-- Dropdown menu -->
                <div v-show="notifications" @mouseleave="toogleNotifications()"
                    class="absolute right-[-15px] top-[35px] w-[25rem] overflow-hidden my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700 rounded-xl">
                    <div
                ...
                <!-- Apps -->
                <button type="button" @click="toogleApps()"
                ...
                <!-- Dropdown menu -->
                <div v-show="apps" @mouseleave="toogleApps()"
                    class="absolute right-[-15px] top-[35px] w-[20rem] overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600 rounded-xl">
                    <div
                        class="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-600 dark:text-gray-300">
                        Apps
                    </div>
                ...
                <button type="button" @click="toogleUser()"
                ...
                <!-- Dropdown menu -->
                <div v-show="profile" @mouseleave="toogleUser()"
                    class="absolute right-[-15px] top-[35px] w-[12.5rem] z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg border-2 dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                    id="dropdown">
                    <div class="py-3 px-4">
...
export default {
    ...
    methods: {
        closeMenus(event) {
            ...
            if (!event.target.closest('#apps-dropdown')) {
                this.apps = false;
            }
