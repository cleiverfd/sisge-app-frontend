        ...
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
          <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
            <ul class="pb-2 space-y-2">
              ...
              <li>
                <button type="button"
                  class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" @click="toogleSidebarBackdrop">
                  <svg
                ...
                <ul class="py-2 space-y-2" v-show="subMenu">
                  <li>
                    <a href="javascript:void(0)"
                      class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" @click="navigateToProceedingAdd">Nuevo</a>
                  </li>
                  <li>
                    <a href="javascript:void(0)"
                      class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" @click="navigateToProceedingSearch">Buscar</a>
                  </li>
                </ul>
              </li>
              <li>
...
export default {
  setup() {
    ...
    // Puedes usar onMounted para realizar acciones después de que el componente se monta
    onMounted(() => {
